...
│   ├── package.json
│   └── tsconfig.json
├── mobile-migracao-local/
│   ├── ARQUITETURA-LOCAL.md
│   ├── CHECKLIST-VSCODE-LOCAL.md
│   ├── CHECKLIST.md
│   ├── env.local.exemplo
│   ├── MAPA-REVISAO.md
│   ├── O-QUE-FAZER-NO-PROJETO.md
│   ├── ORDEM-DE-EXECUCAO.md
│   ├── package-base-exemplo.json
│   ├── package-modelo-local.json
│   ├── PASTA-PATCHES-PLANEJADA.md
│   ├── plano-migracao.json
│   ├── README.md
│   ├── TERMUX-E-VSCODE.md
│   └── VIABILIDADE-LOCAL.md
├── mockup-sandbox/
│   ├── .replit-artifact/
│   │   └── artifact.toml
│   ├── src/
...
### 📁 `mobile-migracao-local/`
> Pasta 'mobile-migracao-local' — agrupamento de arquivos relacionados.
...
Arquivo EXEMPLO — parte do projeto.
...
*Plano gerado pelo SK Code Editor — 30/04/2026, 12:17:56*